...
def main(model_name: str, layer: int, act_name: str, cfg: dict):
    ...
    german_europarl_data = torch.load("data/europarl/de_batched.pt")
    german_wikipedia_data = torch.load("data/wikipedia/de_batched_0.pt")
    ...
    prompt_data = [german_europarl_data, german_wikipedia_data]
